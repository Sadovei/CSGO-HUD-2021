...
export default function HeadToHead({ data, action }) {
    ...
    let leftPicturePlayer = `http://redis-birou.pgl.ro/pgl/resources/csgo/team/${dataH2H?.leftPlayer?.teamKey}/${dataH2H?.leftPlayer?.playerKey}-h2h.webp`
    let rightPicturePlayer = `http://redis-birou.pgl.ro/pgl/resources/csgo/team/${dataH2H?.rightPlayer?.teamKey}/${dataH2H?.rightPlayer?.playerKey}-h2h.webp`
    let flagLeft = `http://redis-birou.pgl.ro/pgl/resources/flags/${dataH2H?.leftPlayer?.flag}.png`
    let flagRight = `http://redis-birou.pgl.ro/pgl/resources/flags/${dataH2H?.leftPlayer?.flag}.png`
        ...
        <animated.div className="headToHead-wrapper font-tablet row"
            ...
            <div className="h2h-info-wrapper col">
                <div className="duels-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            ...
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.duels * 92 / 100}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.duels}%</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.duels * 92 / 100}%` }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="adr-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            ...
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.adr * 92 / dataH2H?.adr}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.adr}</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.adr * 92 / dataH2H?.adr}%` }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="kast-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            ...
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.kast * 92 / dataH2H?.kast}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.kast}</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.kast * 92 / dataH2H?.kast}%` }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="hs-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            ...
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.hs * 92 / 100}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.hs}%</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.hs * 92 / 100}%` }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="accuracy-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            <p className="number number-left">{dataH2H?.leftPlayer.accuracy}%</p>
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.accuracy * 92 / 100}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.accuracy}%</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.accuracy * 92 / 100}%` }}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="utility-wrapper info col">
                    ...
                    <div className="bar-info row">
                        <div className={`bar-wrapper left ${leftSide}`}>
                            <p className="number number-left">{dataH2H?.leftPlayer.grenades_used}</p>
                            <div className="bar" style={{ width: `${dataH2H?.leftPlayer.grenades_used * 92 / dataH2H?.utility_grenades_used}%` }}></div>
                        </div>

                        <div className={`bar-wrapper right ${rightSide}`}>
                            <p className="number number-right">{dataH2H?.rightPlayer.grenades_used}</p>
                            <div className="bar" style={{ width: `${dataH2H?.rightPlayer.grenades_used * 92 / dataH2H?.utility_grenades_used}%` }}></div>
                        </div>
                    </div>
                </div>
            </div>
